...
namespace AspNetCoreBlogMVC.Data
{
    public class AuthDbContext : IdentityDbContext
    {
		...
		protected override void OnModelCreating(ModelBuilder builder)
		{
			...
			{
				UserName = "superadmin@aspnetmvc.com",
				Email = "superadmin@aspnetmvc.com",
				NormalizedEmail = "superadmin@aspnetmvc.com".ToUpper(),
				NormalizedUserName = "superadmin@aspnetmvc.com".ToUpper(),
				Id = superAdminId
			};
